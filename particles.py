...
# ===========================
    ...
    p.sample_position(method="stl", stl_file="nostril_1.stl", normal_offset=0.8, scale=0.7, flip_normal=True)     
    p.generate()
    p.save_vtk()
